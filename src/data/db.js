...
export const workExp = [{
    ...
    role: [
        "Led full-stack development of enterprise web applications serving thousands of users while improving code quality and delivery speed.",
        "Built and launched 59+ dynamic, responsive web pages.", "Increased user engagement by 40% and improved load times by 25%.",
    ...
    toolsUsed:
        [
            { name: "Teck Stacks: React.js, TypeScript, Redux Toolkit, React Query, Tailwind CSS, Storybook, API Integration, AWS/Azure, Git/GitHub, CI/CD." },
            // { name: "TypeScript" },
            // { name: "JavaScript" },
            // { name: "Redux Toolkit" },
            // { name: "React Query" },
